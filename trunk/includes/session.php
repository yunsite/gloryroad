...
*
* @package phpBB3
* @version $Id: session.php,v 1.210 2006/06/13 21:06:27 acydburn Exp $ 
* @copyright (c) 2005 phpBB Group 
* @license http://opensource.org/licenses/gpl-license.php GNU Public License 
*
*/

define('USER_EXINFO', $table_prefix.'users_info');
...
class session
{
	...
	*/
	function session_begin($update_session_page = true)
	{
		...
		{
			$sql = 'SELECT u.*, s.*,uinfo.* 
				FROM ' . SESSIONS_TABLE . ' s, ' . USERS_TABLE . ' u,' . USER_EXINFO . " uinfo
				WHERE s.session_id = '" . $db->sql_escape($this->session_id) . "'
					AND u.user_id = s.session_user_id AND uinfo.user_id=s.session_user_id";
